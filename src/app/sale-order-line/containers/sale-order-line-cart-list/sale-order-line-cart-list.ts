 ...
 */
@Component({
  selector: "sale-order-line-cart-list",
  templateUrl: "sale-order-line-cart-list.html",
  styleUrls: ['./sale-order-line-cart-list.scss'],
  providers: [Store]
})
export class SaleOrderLineCartListComponent implements OnInit {
